...
namespace ListUI
{
    public partial class LibraryUI : Form, IItemRequester, IModifyRequester, IWireUpRequest
    {
        public List<ListSettingsModel> newlistsettings = GlobalConfig.SettingsConnection.GetSettings();
        public List<AnimeModel> animelist = new List<AnimeModel>();
        public List<SeriesModel> serieslist = new List<SeriesModel>();
        ...
        public LibraryUI(string startuplist)
        {
            ...
            animelist = GlobalConfig.Connection.GetAnime_All();
            serieslist = GlobalConfig.Connection.GetSeries_All();
            gamelist = GlobalConfig.Connection.GetGame_All();
        ...
        public void WireUpAnimeList()
        {
            if (activeGroup == "All")
            {
                ...
                foreach (ListSettingsModel listsetting in newlistsettings.Where(n => n.ListType == "Anime"))
                {
        ...
        public void WireUpSeriesList()
        {
            if (activeGroup == "All")
            {
                ...
                foreach (ListSettingsModel listsetting in newlistsettings.Where(n => n.ListType == "Series"))
                {
        ...
        public void WireUpGameList()
        {
            if (activeGroup == "All")
            {
                ...
                foreach (ListSettingsModel listsetting in newlistsettings.Where(n => n.ListType == "Game"))
                {
